...
export default function TeachersPage() {
  ...
  const fetchTeachers = useCallback(
    async (query = "") => {
      try {
        ...
        toast({
          variant: "destructive",
          title: t("teachers_page.fetch_failed_title"),
          description: error.message || t("teachers_page.fetch_failed_desc"),
        });
      } finally {
        setLoading(false);
      }
  ...
  async function handleEditSubmit(values: z.infer<typeof teacherSchema>) {
    ...
    try {
      ...
      toast({
        title: t("success"),
        description: t("teachers_page.update_success"),
      });
      ...
      toast({
        ...
        description:
          error.message || t("teachers_page.update_failed_desc_generic"),
      });
    } finally {
      ...
      {editingTeacher && (
        ...
        >
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>
                {t("teachers_page.edit_title")}
              </AlertDialogTitle>
              <AlertDialogDescription>
                {t("teachers_page.edit_description", {
                  id: editingTeacher.teacherId || editingTeacher.id,
                })}
              </AlertDialogDescription>
            </AlertDialogHeader>
            <Form {...form}>
                      ...
                      <FormItem>
                        ...
                        >
                          <FormControl>
                            <SelectTrigger>
                              <SelectValue
                                placeholder={t("teachers_page.select_gender")}
                              />
                            </SelectTrigger>
                          </FormControl>
                          <SelectContent>
