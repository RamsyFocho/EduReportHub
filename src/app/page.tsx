    ...
    >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              >
                {t("landing_page.nav.features")}
              </a>
              <a
                href="#how-it-works"
                className="text-sm font-medium hover:text-green-600 transition-colors"
              >
                {t("landing_page.nav.how_it_works")}
              </a>
              <a
                href="#testimonials"
                className="text-sm font-medium hover:text-green-600 transition-colors"
              >
                {t("landing_page.nav.testimonials")}
              </a>
              <a
                href="#faq"
                className="text-sm font-medium hover:text-green-600 transition-colors"
              >
                {t("landing_page.nav.faq")}
              </a>
            </nav>
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <Link
                href="/login"
                className="bg-gradient-to-r from-green-500 to-orange-500 text-white px-6 py-2 rounded-lg font-medium hover:from-green-600 hover:to-orange-600 transition-all duration-300 transform hover:scale-105"
              >
          ...
          {isMobileMenuOpen && (
            ...
            >
              <div className="flex flex-col space-y-4">
                ...
                <Link
                  href="/login"
                  className="bg-gradient-to-r from-green-500 to-orange-500 text-white px-6 py-2 rounded-lg font-medium hover:from-green-600 hover:to-orange-600 transition-all duration-300 text-left w-fit"
                >
                  {t("landing_page.hero.get_started")}
                </Link>
              </div>
                  ...
                  >
                    <motion.h1
                      ...
                      dangerouslySetInnerHTML={{
                        __html: t("landing_page.hero.title"),
                      }}
                    ></motion.h1>
                    <motion.p
                      variants={fadeUp}
                      className="text-xl text-green-100 mb-8 max-w-lg mx-auto lg:mx-0"
                    >
                    ...
                    >
                      <Link
                        href="/login"
                        className="bg-white text-gray-900 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2"
                      >
                        {t("landing_page.hero.start_trial")}{" "}
                      ...
                      <button className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-gray-900 transition-all duration-300 flex items-center justify-center gap-2">
                        ...
                        {t("landing_page.hero.watch_demo")}
                      </button>
                    </motion.div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div variants={fadeUp} className="text-center mb-16">
              <h2
                ...
                dangerouslySetInnerHTML={{
                  __html: t("landing_page.features.title"),
                }}
              ></h2>
              <p
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">
                  {t("landing_page.mobile_showcase.title")}
                </h2>
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.div variants={fadeUp}>
              <h3 className="font-semibold mb-4">
                {t("landing_page.footer.product.title")}
              </h3>
              <ul
                className={`space-y-2 ${
                  isDark ? "text-gray-300" : "text-gray-600"
              ...
              >
                <li>
                  ...
                  >
                    {t("landing_page.footer.product.features")}
                  </a>
                </li>
                <li>
                  <a
                    ...
                    className="hover:text-green-600 transition-colors"
                  >
                    {t("landing_page.footer.product.pricing")}
                  </a>
                </li>
                <li>
                  <a
                    ...
                    className="hover:text-green-600 transition-colors"
                  >
                    {t("landing_page.footer.product.integrations")}
                  </a>
                </li>
                <li>
                  <a
                    ...
                    className="hover:text-green-600 transition-colors"
                  >
                    {t("landing_page.footer.product.api")}
                  </a>
                </li>
              </ul>
            </motion.div>
            ...
            <motion.div variants={fadeUp}>
              <h3 className="font-semibold mb-4">
                {t("landing_page.footer.company.title")}
              </h3>
              <ul
                className={`space-y-2 ${
                  isDark ? "text-gray-300" : "text-gray-600"
              ...
              >
                <li>
                  <a
                    ...
                    className="hover:text-green-600 transition-colors"
                  >
                    {t("landing_page.footer.company.about")}
                  </a>
                </li>
                <li>
                  <a
                    ...
                    className="hover:text-green-600 transition-colors"
                  >
                    {t("landing_page.footer.company.blog")}
                  </a>
                </li>
                <li>
                  <a
                    ...
                    className="hover:text-green-600 transition-colors"
                  >
                    {t("landing_page.footer.company.careers")}
                  </a>
                </li>
                <li>
                  <a
                    ...
                    className="hover:text-green-600 transition-colors"
                  >
                    {t("landing_page.footer.company.contact")}
                  </a>
                </li>
              </ul>
            </motion.div>
            ...
            <motion.div variants={fadeUp}>
              <h3 className="font-semibold mb-4">
                {t("landing_page.footer.support.title")}
              </h3>
              <ul
                className={`space-y-2 ${
                  isDark ? "text-gray-300" : "text-gray-600"
              ...
              >
                <li>
                  <a
                    ...
                    className="hover:text-green-600 transition-colors"
                  >
                    {t("landing_page.footer.support.help_center")}
                  </a>
                </li>
                <li>
                  <a
                    ...
                    className="hover:text-green-600 transition-colors"
                  >
                    {t("landing_page.footer.support.documentation")}
                  </a>
                </li>
                <li>
                  <a
                    ...
                    className="hover:text-green-600 transition-colors"
                  >
                    {t("landing_page.footer.support.status")}
                  </a>
                </li>
                <li>
                  <a
                    ...
                    className="hover:text-green-600 transition-colors"
                  >
                    {t("landing_page.footer.support.privacy_policy")}
                  </a>
                </li>
              </ul>
            </motion.div>
          ...
          <hr
            className={`my-8 ${isDark ? "border-gray-800" : "border-gray-200"}`}
          />
